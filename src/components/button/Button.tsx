	...
	(
		...
		return (
			<button
				...
				disabled={disabled}
				className={cn(
					'outline-none rounded-xl disabled:bg-disabled text-invert disabled:text-brand-disabled flex items-center gap-3 justify-center',
					{
					...
					{
						'bg-transparent hover:bg-primary-100 active:bg-primary-200 text-brand disabled:bg-transparent':
							variant === 'ghost',
					},
					{
